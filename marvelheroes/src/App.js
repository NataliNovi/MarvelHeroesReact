...
const heroes = [
 ...
 {  
    ...
    info: "Капитан Америка — персонаж, целеноправленно созданный, чтобы воплощать идеалы патриотизма. Потому он был особенно популярный во время Второй мировой войны. В комиксах обращение «Капитан Америка» применяется к любому, кто выбран правительством США. Больше всего оно закрепилось именно за Стивом Роджерсом.",
    id: "captain"},
 {   
    name: "Тор",
...
function App() {
  return (
    <div className="App">
      ...
      <div class="title">Marvel Heroes</div>

      <div class="hero-table">

      {
        heroes.map((hero) => 
        <Hero name={hero.name} photo={hero.photo} universe={hero.universe} ego={hero.ego} activity={hero.activity} friends={hero.friends} superpower={hero.superpower} info={hero.info} id={hero.id}></Hero>)
      }
